...
class CalendarExportService {
  ...
  showExportOptions(election, onSelect) {
    const options = [
      { service: 'google', label: 'Google Calendar', icon: '📅' },
      { service: 'outlook', label: 'Outlook Calendar', icon: '📆' },
      { service: 'ics', label: 'Download ICS File', icon: '📄' }
    ];
...
export default { notificationService, calendarExportService };