...
import LiveVoteDashboard from '../../components/dashboard/LiveVoteDashboard';
import { 
  Users, 
  Vote, 
  Calendar, 
    ...
    <div className="p-6">
      ...
      <div className="mt-8 bg-white rounded-lg shadow p-6">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold text-gray-900">Live Election Dashboard</h3>
          <Link to="/live-results" className="text-blue-600 hover:text-blue-800 text-sm font-medium">
            View full page
          </Link>
        </div>
        <LiveVoteDashboard />
